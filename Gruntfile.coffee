module.exports = (grunt) ->
  grunt.initConfig
    ...
    exec:
      print: 'decktape -s 1024x768 reveal "http://localhost:9000/" print.pdf --chrome-arg=--no-sandbox; true'
      thumbnail: 'decktape -s 800x600 --screenshots --screenshots-directory . --slides 1 reveal "http://localhost:9000/#/title" dist/img/<%= pkg.shortname %>.jpg --chrome-arg=--no-sandbox; true'
