module.exports = (grunt) ->
  grunt.initConfig
    ...
    exec:
      ...
      thumbnail: 'decktape -s 800x600 --screenshots --screenshots-directory . --slides 1 --chrome-arg=--no-sandbox reveal "http://localhost:9000/#/title" dist/img/<%= pkg.shortname %>.jpg; true'
